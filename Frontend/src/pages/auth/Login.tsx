...
export default function Login() {
  ...
  return (
    <div style={{ minHeight:"100vh", display:"flex", alignItems:"center", justifyContent:"center", background:"#F7F6F2", padding:"80px 20px" }}>
      <div style={{ background:"white", border:"1px solid rgba(0,0,0,0.08)", borderRadius:20, padding:"40px", width:"100%", maxWidth:400 }}>
        <div style={{ textAlign:"center", marginBottom:28 }}>
          ...
          <div style={{ fontFamily:"'Syne',sans-serif", fontSize:24, fontWeight:800, letterSpacing:-1 }}>Welcome back</div>
          <div style={{ fontSize:13, color:"#6B6960", marginTop:6, fontWeight:300 }}>Log in to your account</div>
        </div>
        <div style={{ display:"flex", flexDirection:"column", gap:14 }}>
          ...
          <div>
            <label style={{ fontSize:11, fontWeight:600, color:"#A8A69E", textTransform:"uppercase", letterSpacing:1, display:"block", marginBottom:6 }}>Email</label>
            <input type="email" value={email} onChange={e=>setEmail(e.target.value)} placeholder="you@example.com" style={inputStyle}
              onFocus={e=>e.target.style.borderColor="#7C5CFC"} onBlur={e=>e.target.style.borderColor="rgba(0,0,0,0.08)"} />
          </div>
          <div>
            <label style={{ fontSize:11, fontWeight:600, color:"#A8A69E", textTransform:"uppercase", letterSpacing:1, display:"block", marginBottom:6 }}>Password</label>
          ...
          <div style={{ textAlign:"center", fontSize:13, color:"#6B6960", fontWeight:300 }}>
            ...
            <Link to="/register" style={{ color:"#7C5CFC", fontWeight:500, textDecoration:"none" }}>Sign up</Link>
          </div>
        </div>
      </div>
    </div>
